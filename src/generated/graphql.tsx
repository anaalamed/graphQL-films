...
export type FilmsListQuery = { __typename?: 'Root', allFilms?: { __typename?: 'FilmsConnection', films?: Array<{ __typename?: 'Film', title?: string | null | undefined, id: string } | null | undefined> | null | undefined } | null | undefined };

export type FilmProfileQueryVariables = Exact<{
  filmId?: Maybe<Scalars['ID']>;
}>;


export type FilmProfileQuery = { __typename?: 'Root', film?: { __typename?: 'Film', title?: string | null | undefined, episodeID?: number | null | undefined, openingCrawl?: string | null | undefined, director?: string | null | undefined, producers?: Array<string | null | undefined> | null | undefined, releaseDate?: string | null | undefined, created?: string | null | undefined, edited?: string | null | undefined, id: string, characterConnection?: { __typename?: 'FilmCharactersConnection', characters?: Array<{ __typename?: 'Person', name?: string | null | undefined, homeworld?: { __typename?: 'Planet', name?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined, vehicleConnection?: { __typename?: 'FilmVehiclesConnection', vehicles?: Array<{ __typename?: 'Vehicle', name?: string | null | undefined, model?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined };
...
/**
 * __useFilmsListQuery__
 *
 * To run a query within a React component, call `useFilmsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useFilmsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFilmsListQuery({
 *   variables: {
 *   },
 * });
 */
export function useFilmsListQuery(baseOptions?: Apollo.QueryHookOptions<FilmsListQuery, FilmsListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FilmsListQuery, FilmsListQueryVariables>(FilmsListDocument, options);
      }
export function useFilmsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FilmsListQuery, FilmsListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FilmsListQuery, FilmsListQueryVariables>(FilmsListDocument, options);
        }
export type FilmsListQueryHookResult = ReturnType<typeof useFilmsListQuery>;
export type FilmsListLazyQueryHookResult = ReturnType<typeof useFilmsListLazyQuery>;
export type FilmsListQueryResult = Apollo.QueryResult<FilmsListQuery, FilmsListQueryVariables>;
export const FilmProfileDocument = gql`
...
/**
 * __useFilmProfileQuery__
 *
 * To run a query within a React component, call `useFilmProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useFilmProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFilmProfileQuery({
 *   variables: {
 *      filmId: // value for 'filmId'
 *   },
 * });
 */
export function useFilmProfileQuery(baseOptions?: Apollo.QueryHookOptions<FilmProfileQuery, FilmProfileQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FilmProfileQuery, FilmProfileQueryVariables>(FilmProfileDocument, options);
      }
export function useFilmProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FilmProfileQuery, FilmProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FilmProfileQuery, FilmProfileQueryVariables>(FilmProfileDocument, options);
        }
export type FilmProfileQueryHookResult = ReturnType<typeof useFilmProfileQuery>;
export type FilmProfileLazyQueryHookResult = ReturnType<typeof useFilmProfileLazyQuery>;
export type FilmProfileQueryResult = Apollo.QueryResult<FilmProfileQuery, FilmProfileQueryVariables>;